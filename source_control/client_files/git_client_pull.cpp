/* The following directives enable cross-platforming by only 
activating the headers on their respective operating systems. */
#ifdef _WIN32
...
bool download_file(const SOCKET sd, const std::string & filename, const std::string & dir,
